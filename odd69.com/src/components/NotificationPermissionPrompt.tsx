    ...
    return (
        <>
            ...
            <div
                ...
                className="fixed inset-0 bg-black/70 z-[800]"
            />
            ...
            <div
                className={`
                    ...
                    overflow-hidden
                    bg-gradient-to-br from-[#12161e] to-[#0c0f14]
                ...
                <div className="px-6 pb-6 pt-4 md:p-8">
                    ...
                    {step === 'success' && (
                        <div className="flex flex-col items-center text-center py-6 gap-3">
                            ...
                            <h2 className="text-xl font-black text-white tracking-tight">Notifications enabled!</h2>
                    ...
                    {step === 'denied' && (
                        <div className="flex flex-col items-center text-center py-4 gap-3">
                            ...
                            <h2 className="text-xl font-black text-white tracking-tight">Notifications are blocked</h2>
                            ...
                            <div className="w-full space-y-2 mt-1">
                                {[
                                    ...
                                    >
                                        <span className="flex-shrink-0 w-5 h-5 rounded-full bg-amber-500/20 text-amber-400 text-[10px] font-black flex items-center justify-center mt-0.5">
                                            {i + 1}
                                        </span>
                            ...
                            <button
                                ...
                                className="mt-1 px-6 py-2.5 rounded-xl bg-white/[0.08] text-white/70 text-sm font-black hover:bg-white/[0.12] transition-colors tracking-tight"
                            >
                                Got it, thanks
                            </button>
                        </div>
                        ...
                        <>
                            ...
                            <div className="flex items-start justify-between mb-5">
                                <div className="flex items-center gap-3">
                                    <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-amber-500/25 to-orange-500/10 border border-amber-500/20 flex items-center justify-center flex-shrink-0">
                                ...
                                {BENEFITS.map((b, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="min-w-0 flex-1">
                                            <p className="text-[12px] font-black text-white leading-tight tracking-tight">{b.title}</p>
                            ...
                            {/* Privacy line */}
                            <p className="text-[10px] text-white/25 text-center mb-4 px-2 leading-relaxed">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2.5">
                                ...
                                <button
                                    onClick={handleLater}
                                    className="px-5 py-3.5 rounded-2xl text-[12px] font-black text-white/50 hover:text-white/70 hover:bg-white/[0.06] border border-white/[0.06] hover:border-white/[0.08] transition-all tracking-tight"
                                >
                                    Maybe later
                                </button>
                            </div>
...
function Spinner() {
    return (
        <svg className="animate-spin h-4 w-4 text-[#1a1208] flex-shrink-0" viewBox="0 0 24 24" fill="none">
