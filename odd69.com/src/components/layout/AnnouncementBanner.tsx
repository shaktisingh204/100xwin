...
const TYPE_STYLES: Record<AnnouncementType, TypeStyle> = {
    INFO: {
        bar: 'bg-gradient-to-r from-amber-500/20 to-orange-500/10 border-amber-500/30',
        icon: Info,
        text: 'text-amber-300',
    ...
    SUCCESS: {
        bar: 'bg-gradient-to-r from-emerald-500/15 to-emerald-500/5 border-emerald-500/30',
        icon: CheckCircle,
        text: 'text-emerald-300',
        dismiss: 'hover:bg-emerald-500/20 text-emerald-300',
    },
    PROMO: {
        bar: 'bg-gradient-to-r from-amber-500/20 to-orange-500/10 border-amber-500/30',
        icon: Zap,
