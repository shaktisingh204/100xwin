        ...
        <>
            <style jsx>{`
                ...
                @keyframes pendingIconGlow {
                    0%, 100% {
                        box-shadow: 0 4px 12px rgba(245, 158, 11, 0.45), 0 0 0 0 rgba(245, 158, 11, 0.35);
                    }
                    50% {
                        box-shadow: 0 4px 16px rgba(245, 158, 11, 0.65), 0 0 0 5px rgba(245, 158, 11, 0);
                    }
                }
                ...
                {collapsed ? (
                    isMobile ? (
                        ...
                        >
                            ...
                            >
                                <Clock size={14} className="text-[#06080c]" />
                            </div>
                            <span
                        ...
                        >
                            ...
                            >
                                <Clock size={18} className="text-[#06080c]" />
                            </div>
                    ...
                    >
                        ...
                        <div className={`flex flex-col items-center gap-1.5 ${isMobile ? 'pt-3 pb-2 px-3' : 'pt-5 pb-4 px-4'}`}>
                            ...
                            >
                                <span className={`text-[#06080c] ${isMobile ? 'text-[15px]' : 'text-[18px]'} font-black`}>₹</span>
                            </div>
                            <span className={`${isMobile ? 'text-[20px]' : 'text-[24px]'} font-black text-white tabular-nums leading-tight mt-1`}>
                        ...
                        {showMore && txn.paymentMethod && (
                            <div className="mx-4 mb-2 rounded-xl px-3 py-2.5" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
                        ...
                        {/* UTR verify */}
                        {!txn.utr && (
                            <div className="mx-4 mt-2 rounded-xl p-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)' }}>
                                ...
                                <button
                                    ...
                                    className="w-full mt-2 py-2 rounded-lg text-[12px] font-black text-[#06080c] transition-colors disabled:opacity-40"
                        ...
                        <div className="flex gap-2 px-4 pt-3 pb-1.5">
                            ...
                            <button
                                ...
                                className="flex flex-1 items-center justify-center gap-1.5 py-2.5 rounded-lg text-[11px] font-black transition-colors text-[#06080c]"
