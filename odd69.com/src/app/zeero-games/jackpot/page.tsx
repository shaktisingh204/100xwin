...
const TIERS: { tier: JackpotResult["tier"]; mult: number; color: string }[] = [
  { tier: "BUST", mult: 0, color: "bg-white/[0.03] text-white/50 border border-white/[0.08]" },
  ...
  { tier: "GRAND", mult: 180, color: "bg-amber-500/20 text-amber-200 border border-amber-400/40" },
];
            ...
            return (
              <div
                ...
                className={`rounded-2xl p-5 text-center font-black transition-all ${t.color} ${
                  active
                    ? "ring-4 ring-amber-300/60 scale-110 shadow-[0_0_30px_rgba(245,158,11,0.4)]"
                    : ""
                }`}
              >
