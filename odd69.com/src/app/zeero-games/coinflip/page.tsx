            ...
            className={`w-48 h-48 rounded-full border-[10px] flex flex-col items-center justify-center transition-all duration-500 ${
              result?.status === "WON"
                ...
                : result?.status === "LOST"
                  ...
                  : "border-amber-400/60 shadow-[0_0_40px_rgba(245,158,11,0.35)]"
            } bg-gradient-to-br from-amber-300 via-amber-500 to-orange-700`}
          >
            <div className="text-[#1a1208] text-7xl font-black">
              {result ? (result.result === "heads" ? "H" : "T") : "?"}
            </div>
            <div className="text-[10px] text-[#1a1208]/80 uppercase tracking-wider font-bold">
