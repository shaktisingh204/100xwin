          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative flex-1 h-1.5 mt-2 mb-2">
                <div className="absolute inset-0 bg-white/[0.03] rounded-full border border-white/[0.06] overflow-hidden">
                  <div
                    className="absolute left-0 top-0 h-full bg-gradient-to-r from-amber-500 to-orange-600 rounded-full transition-all"
                    style={{
                ...
                />
                <div
                  className="absolute top-[-7px] w-5 h-5 bg-white rounded-full border-2 border-amber-500 shadow-lg pointer-events-none transition-all z-10"
                  style={{
      ...
      >
        ...
        <div className="relative" style={{ width: SIZE, height: SIZE }}>
          ...
          >
            ...
            <circle cx={CX} cy={CY} r={R_IN - 6} fill="#0f0a04" />
            <circle
              cx={CX}
              cy={CY}
              r={R_IN - 6}
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="text-center">
              <div className="text-[10px] uppercase text-white/50 tracking-wider font-bold">
                {risk}
              </div>
              ...
              return (
                <div
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-mono font-bold border-b-4 transition-all ${
                    active ? "scale-110 ring-2 ring-amber-400/60" : ""
                  }`}
                  style={{
