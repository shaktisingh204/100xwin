                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            ...
                            boxShadow:
                                "0 25px 60px rgba(0,0,0,0.5), 0 0 80px rgba(255,106,0,0.03), inset 0 1px 0 rgba(255,255,255,0.1)",
                        }}
                    >
                        {/* Glow effects */}
                        <div className="absolute -top-20 -right-20 w-60 h-60 bg-[#ff6a00]/20 rounded-full blur-[80px] pointer-events-none" />
                        ...
                        <div className="relative z-[1] px-8 pt-10 pb-8 flex flex-col items-center text-center">
                            ...
                            >
                                <div className="w-24 h-24 rounded-2xl bg-gradient-to-br from-[#ff6a00] to-[#cc5500] flex items-center justify-center shadow-lg shadow-[#ff6a00]/30 rotate-6">
                            ...
                            <button
                                ...
                                className="group w-full h-[54px] rounded-xl bg-gradient-to-r from-[#ff6a00] to-[#f59e0b] hover:from-[#f59e0b] hover:to-[#ff6a00] text-white font-extrabold text-base uppercase tracking-wider flex items-center justify-center gap-2 transition-all duration-300 shadow-lg shadow-[#ff6a00]/25 hover:shadow-[#ff6a00]/40 hover:-translate-y-0.5 active:translate-y-0"
                            >
                                Make a Deposit
                                <ArrowRight
                                    size={18}
            ...
            <div className="md:hidden fixed inset-0 z-[60] flex items-end bg-black/80 backdrop-blur-md animate-in fade-in duration-300">
                ...
                >
                    <div
                        ...
                        style={{
                            boxShadow:
                                "0 -15px 50px rgba(0,0,0,0.4), 0 0 60px rgba(255,106,0,0.02), inset 0 1px 0 rgba(255,255,255,0.1)",
                        }}
                    >
                        {/* Glow effects */}
                        <div className="absolute -top-16 right-8 w-40 h-40 bg-[#ff6a00]/20 rounded-full blur-[60px] pointer-events-none" />
                        ...
                        <div className="relative z-[1] px-6 pt-2 pb-8 flex flex-col items-center text-center">
                            ...
                            >
                                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#ff6a00] to-[#cc5500] flex items-center justify-center shadow-lg shadow-[#ff6a00]/30 rotate-6">
                            ...
                            <button
                                onClick={handleDeposit}
                                className="group w-full h-[52px] rounded-xl bg-gradient-to-r from-[#ff6a00] to-[#f59e0b] hover:from-[#f59e0b] hover:to-[#ff6a00] text-white font-extrabold text-[15px] uppercase tracking-wider flex items-center justify-center gap-2 transition-all duration-300 shadow-lg shadow-[#ff6a00]/25"
                            >
                                Make a Deposit
                                <ArrowRight
                                    size={17}
